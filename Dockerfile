...
# Set proper permissions for the SSH directory and authorized_keys
RUN chmod 700 /home/jenkins/.ssh && \
    chmod 600 /home/jenkins/.ssh/authorized_keys

# Add the Maven settings.xml file
COPY settings.xml /home/jenkins/.m2/settings.xml

# Set ownership for Jenkins user's directories
RUN chown -R jenkins:jenkins /home/jenkins/.m2 /home/jenkins/.ssh /home/jenkins/workspace
